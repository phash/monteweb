      ...
      admin: {
        ...
        system: {
          ...
          privacy: {
            ...
            content: 'Verwalte Datenschutzerklärung und Nutzungsbedingungen unter „Datenschutz". Texte werden als HTML hinterlegt und unterstützen Platzhalter ({{SCHOOL_NAME}}, {{SCHOOL_ADDRESS}}, etc.). Nutzer müssen neue Versionen der Nutzungsbedingungen akzeptieren.',
