    ...
    handbook: {
      ...
      admin: {
        ...
        system: {
          ...
          privacy: {
            title: 'Privacy (GDPR)',
            content: 'Manage the privacy policy and terms of service under "Privacy". Texts are stored as HTML and support placeholders ({{SCHOOL_NAME}}, {{SCHOOL_ADDRESS}}, etc.). Users must accept new versions of the terms of service.',
