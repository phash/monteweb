...
export const adminApi = {
  ...
  updateConfig(data: { schoolName?: string; logoUrl?: string; targetHoursPerFamily?: number; targetCleaningHours?: number; bundesland?: string; schoolVacations?: { name: string; from: string; to: string }[]; requireAssignmentConfirmation?: boolean; multilanguageEnabled?: boolean; defaultLanguage?: string; requireUserApproval?: boolean }) {
